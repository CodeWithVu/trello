  ...
  return (
    <Menu>
      ...
      <MenuItems
        ...
        transition
        anchor="bottom end"
        className="z-50 w-42 origin-top-right rounded-xl border border-white/5 bg-white p-1 text-sm/6 text-(--color-primary) transition duration-100 ease-out [--anchor-gap:--spacing(1)] focus:outline-none data-closed:scale-95 data-closed:opacity-0">
        {links.map((link) => (
