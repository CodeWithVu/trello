...
function Tooltip({ children, content, className, contentClassName }) {
  ...
  return (
    <>
      ...
      {isVisible && createPortal(
        <div
          className={`fixed z-9999 px-2 py-1 bg-gray-800 text-white text-xs rounded -translate-x-1/2 pointer-events-none ${contentClassName || ''}
